...
public class Bencoder {
	...
	/**
	 * Parses a bencoded String located <code>input[index</code> and returns it as a
	 * String object.
	 * 
	 * @param input
	 *            Contains bencoded data.
	 * @param index
	 *            A valid index into <code>data</code> that points to the beginning
	 *            of a bencoded String.
	...
	/**
	 * Parses a bencoded Integer stored in <code>input</code> and returns it as an
	 * Integer object.
	 * 
	 * @param input
	 *            Contains bencoded data.
	 * @param index
	 *            A valid index into <code>input</code> that points to the beginning
	 *            of a bencoded Integer.
	...
	/**
	 * Bencodes a HashMap into a bencoded dictionary.The HashMap must contain only
	 * bencoded strings representing bencoded integers, strings, lists, and
	 * dictionaries.
	 * 
	 * @param input
	 *            A HashMap containing bencoded objects representing the entries in
	 *            a dictionary.
	 * @return an array of bytes with the bencoded data.
	 */
	...
	/**
	 * Parses a bencoded Dictionary represented by <code>input</code> and returns it
	 * as a Map object.
	 * 
	 * @param input
	...
	/**
	 * Parses a bencoded Dictionary located <code>input[index]</code> and returns it
	 * as a Map object.
	 * 
	 * @param input
	 *            Contains bencoded input.
	...
	/**
	 * Takes a vector of bencoded objects and returns a bencoded list containing the
	 * same data.
	 * 
	 * @param input
	 *            A Vector<Object> containing bencoded data.
	 * @return an array of bytes with the bencoded data.
	 */
	public byte[] bencodeList(List<Object> input) {
		...
		for (int i = 0; i < listElements.size(); i++) {
			for (int j = 0; j < ((byte[]) listElements.get(i)).length; j++) {
				bencodedList[index] = ((byte[]) listElements.get(i))[j];
				index++;
			}
		}
	...
	/**
	 * Parses a bencoded List stored in <code>input</code> and returns it as a List
	 * object.
	 * 
	 * @param input
	...
	public List<Object> unbencodeList(byte[] input, Index index) {
		...
		while ((next_data_type != STRUCTURE_END) && (next_data_type != NULL_TYPE) && (index.index < input.length)) {
			...
			default:
				System.err.println(
						"Error: The object at position " + index.index + " is not a valid bencoded data type.");
				return null;
			}
	...
	/**
	 * Reads the byte at <code>input[index]</code> and returns an integer based on
	 * the value.
	 * 
	 * @param input
	 *            Contains bencoded input.
	...
	public int getEncodedType(byte[] input, int index) {
		...
		case 'e':
			...
			break;
		default:
			System.err.println("Error: The byte at position " + index
